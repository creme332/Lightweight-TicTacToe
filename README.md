...
Implementation of an unbeatable TicTacToe AI in as few lines of code as possible without sacrificing readability and performance. AI uses minimax algorithm with alpha-beta pruning.
## 🚀 Getting started
